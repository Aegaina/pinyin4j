...
public class NewPinyinHelperTest {
  ...
  public void test() throws BadHanyuPinyinOutputFormatCombination {
    ...
    assertEquals("yī rì qiān lĭ", PinyinHelper.toHanYuPinyinString("一日,千里", format, " ", false,
        false));

    assertEquals("yī rì qiān lĭ", PinyinHelper.toHanYuPinyinString("一日,千里", format, " ", false,
        true));

    assertEquals("yī rì qiān lĭ", PinyinHelper.toHanYuPinyinString(",一日千里", format, " ", false,
        false));
